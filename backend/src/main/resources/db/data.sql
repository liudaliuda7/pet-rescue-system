...
(8, 4, '领养前全面体检，各项指标正常', '王医生', '2026-05-10'),
(9, 4, '领养后复查，体重增长正常，精神状态佳', '李医生', '2026-05-25');

INSERT INTO station_review(id, station_id, user_id, adoption_id, rating, content) VALUES
(1, 1, 4, 1, 5, '救助站工作人员非常热心，大黄在站里被照顾得很好，领养流程也很规范，非常感谢！'),
(2, 1, 5, 1, 4, '服务态度好，环境整洁，动物看起来都很健康。希望以后可以增加周末开放时间。'),
(3, 2, 4, 1, 5, '北郊动物之家的兽医团队很专业，对每只动物都尽心照料，值得信赖的救助站。');
